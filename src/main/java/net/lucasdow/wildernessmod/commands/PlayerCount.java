...
public class PlayerCount implements Command{
    ...
    public static void addTierToMessage(int tier, LiteralText message) {
        ...
        switch (tier) {
            ...
            case 7 -> formattedTierText = (LiteralText) new LiteralText("Tier " + tier + " ").formatted(Formatting.YELLOW).formatted(Formatting.UNDERLINE);
            case 6 -> formattedTierText = (LiteralText) new LiteralText("Tier " + tier + " ").formatted(Formatting.DARK_GREEN).formatted(Formatting.UNDERLINE);
            case 5 -> formattedTierText = (LiteralText) new LiteralText("Tier " + tier + " ").formatted(Formatting.GREEN).formatted(Formatting.UNDERLINE);
            ...
            case 3 -> formattedTierText = (LiteralText) new LiteralText("Tier " + tier + " ").formatted(Formatting.RED).formatted(Formatting.UNDERLINE);
            case 2 -> formattedTierText = (LiteralText) new LiteralText("Tier " + tier + " ").formatted(Formatting.AQUA).formatted(Formatting.UNDERLINE);
            case 1 -> formattedTierText = (LiteralText) new LiteralText("Tier " + tier + " ").formatted(Formatting.GOLD).formatted(Formatting.UNDERLINE);
